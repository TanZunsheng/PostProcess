#!/bin/bash
# BrainOmniPostProcess 处理 Brennan_Hale2019 数据集
...
# 显示配置信息
echo "==========================================="
echo "BrainOmni 后处理 - Brennan_Hale2019 数据集"
echo "==========================================="
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "  - 日志: $OUTPUT_DIR/$DATASET/processing_metadata.json"
else
    echo ""
    echo "==========================================="
