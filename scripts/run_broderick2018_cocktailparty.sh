#!/bin/bash
# Broderick2018_CocktailParty 数据集后处理脚本
...
DATASET="Broderick2018_CocktailParty"  # 子数据集名称
...
# 显示配置信息
echo "==========================================="
echo "Broderick2018_CocktailParty 数据集后处理"
echo "==========================================="
echo "输入目录: $INPUT_DIR"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo ""
    echo "==========================================="
    echo "✓ Broderick2018_CocktailParty 处理完成！"
    echo "==========================================="
